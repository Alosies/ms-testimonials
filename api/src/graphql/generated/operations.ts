...
/** Defines branching paths for forms. Each form has flows (shared, testimonial, improvement) that determine step visibility based on user responses like rating. See ADR-009 for architecture details. */
export type FlowsBranch_ValueArgs = {
...
export const Form_Analytics_Events_Constraint = {
  /** unique or primary key constraint on columns "id" */
  FormAnalyticsEventsPkey: 'form_analytics_events_pkey'
} as const;

export type Form_Analytics_Events_Constraint = typeof Form_Analytics_Events_Constraint[keyof typeof Form_Analytics_Events_Constraint];
/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
...
export const Form_Analytics_Events_Select_Column = {
  /** column name */
  CreatedAt: 'created_at',
  /** column name */
...
export type Form_Analytics_Events_Select_Column = typeof Form_Analytics_Events_Select_Column[keyof typeof Form_Analytics_Events_Select_Column];
...
export const Form_Analytics_Events_Update_Column = {
  /** column name */
  CreatedAt: 'created_at',
  /** column name */
  EventData: 'event_data',
...
export type Form_Analytics_Events_Update_Column = typeof Form_Analytics_Events_Update_Column[keyof typeof Form_Analytics_Events_Update_Column];
...
export type CreateTestFlowMutation = { __typename?: 'mutation_root', insert_flows_one: { __typename?: 'flows', id: string } | null };

export type CleanupOldTestFormsMutationVariables = Exact<{
  organization_id: Scalars['String']['input'];
  cutoff_time: Scalars['timestamptz']['input'];
}>;


export type CleanupOldTestFormsMutation = { __typename?: 'mutation_root', update_forms: { __typename?: 'forms_mutation_response', affected_rows: number } | null };

export type CreateTestFormMutationVariables = Exact<{
  organization_id: Scalars['String']['input'];
  name: Scalars['String']['input'];
...
export type CreateTestFormMutation = { __typename?: 'mutation_root', insert_forms_one: { __typename?: 'forms', id: string, name: string } | null };

export type SoftDeleteTestFormMutationVariables = Exact<{
  id: Scalars['String']['input'];
}>;
...
export type InsertFormAnalyticsEventMutationVariables = Exact<{
  organization_id: Scalars['String']['input'];
  form_id: Scalars['String']['input'];
  ...
  step_id?: InputMaybe<Scalars['String']['input']>;
  step_type?: InputMaybe<Scalars['String']['input']>;
  event_data: Scalars['jsonb']['input'];
  user_agent?: InputMaybe<Scalars['String']['input']>;
}>;


export type InsertFormAnalyticsEventMutation = { __typename?: 'mutation_root', insert_form_analytics_events_one: { __typename?: 'form_analytics_events', id: string } | null };

export type CreateTestFormQuestionMutationVariables = Exact<{
  step_id: Scalars['String']['input'];
  organization_id: Scalars['String']['input'];
  question_type_id: Scalars['String']['input'];
  question_text: Scalars['String']['input'];
  question_key: Scalars['String']['input'];
  display_order: Scalars['smallint']['input'];
...
export type FindOrganizationByIdQuery = { __typename?: 'query_root', organizations_by_pk: { __typename?: 'organizations', id: string, name: string, slug: string, is_active: boolean, created_by: string | null } | null };
...
export type FindOrganizationBySlugQuery = { __typename?: 'query_root', organizations: Array<{ __typename?: 'organizations', id: string, name: string, slug: string, is_active: boolean, created_by: string | null }> };
...
export type AssignRoleMutationVariables = Exact<{
  ...
  is_default_org: Scalars['Boolean']['input'];
}>;


export type AssignRoleMutation = { __typename?: 'mutation_root', insert_organization_roles_one: { __typename?: 'organization_roles', id: string, organization_id: string, user_id: string, role_id: string, is_default_org: boolean } | null };

export type FetchUserRoleInOrgQueryVariables = Exact<{
  userId: Scalars['String']['input'];
  organizationId: Scalars['String']['input'];
}>;


export type FetchUserRoleInOrgQuery = { __typename?: 'query_root', organization_roles: Array<{ __typename?: 'organization_roles', id: string, organization_id: string, role_id: string, is_default_org: boolean, organization: { __typename?: 'organizations', id: string, name: string, slug: string }, role: { __typename?: 'roles', id: string, name: string, unique_name: string } }> };

export type FetchUserRolesQueryVariables = Exact<{
  userId: Scalars['String']['input'];
}>;


export type FetchUserRolesQuery = { __typename?: 'query_root', organization_roles: Array<{ __typename?: 'organization_roles', id: string, organization_id: string, role_id: string, is_default_org: boolean, joined_at: string, organization: { __typename?: 'organizations', id: string, name: string, slug: string, is_active: boolean }, role: { __typename?: 'roles', id: string, name: string, unique_name: string, can_manage_forms: boolean, can_manage_testimonials: boolean, can_manage_widgets: boolean, can_manage_members: boolean, can_manage_billing: boolean, can_delete_org: boolean, is_viewer: boolean } }> };

export type UpdateDefaultOrgMutationVariables = Exact<{
  id: Scalars['String']['input'];
  is_default_org: Scalars['Boolean']['input'];
}>;


export type UpdateDefaultOrgMutation = { __typename?: 'mutation_root', update_organization_roles_by_pk: { __typename?: 'organization_roles', id: string, is_default_org: boolean } | null };

export type CreateOrganizationPlanMutationVariables = Exact<{
  organization_id: Scalars['String']['input'];
  plan_id: Scalars['String']['input'];
  max_forms: Scalars['Int']['input'];
  max_members: Scalars['Int']['input'];
  max_testimonials: Scalars['Int']['input'];
  max_widgets: Scalars['Int']['input'];
  show_branding: Scalars['Boolean']['input'];
}>;


export type CreateOrganizationPlanMutation = { __typename?: 'mutation_root', insert_organization_plans_one: { __typename?: 'organization_plans', id: string, organization_id: string, plan_id: string, status: string } | null };

export type FindFreePlanQueryVariables = Exact<{ [key: string]: never; }>;
...
export type FindRoleByUniqueNameQuery = { __typename?: 'query_root', roles: Array<{ __typename?: 'roles', id: string, name: string, unique_name: string }> };
...
export type CreateUserMutation = { __typename?: 'mutation_root', insert_users_one: { __typename?: 'users', id: string, email: string, email_verified: boolean, display_name: string | null, avatar_url: string | null, locale: string } | null };
...
export type FindUserByEmailQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', id: string, email: string, email_verified: boolean, display_name: string | null, avatar_url: string | null, locale: string, timezone: string, is_active: boolean }> };
...
export type FindUserByIdQuery = { __typename?: 'query_root', users_by_pk: { __typename?: 'users', id: string, email: string, email_verified: boolean, display_name: string | null, avatar_url: string | null, locale: string, timezone: string, is_active: boolean, last_login_at: string | null, created_at: string } | null };

export type UpdateUserLoginMutationVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type UpdateUserLoginMutation = { __typename?: 'mutation_root', update_users_by_pk: { __typename?: 'users', id: string, last_login_at: string | null } | null };

export type CountUserIdentitiesQueryVariables = Exact<{
  userId: Scalars['String']['input'];
}>;


export type CountUserIdentitiesQuery = { __typename?: 'query_root', user_identities_aggregate: { __typename?: 'user_identities_aggregate', aggregate: { __typename?: 'user_identities_aggregate_fields', count: number } | null } };

export type CreateIdentityMutationVariables = Exact<{
  user_id: Scalars['String']['input'];
  provider: Scalars['String']['input'];
  provider_user_id: Scalars['String']['input'];
  provider_email?: InputMaybe<Scalars['String']['input']>;
  provider_metadata?: InputMaybe<Scalars['jsonb']['input']>;
  is_primary: Scalars['Boolean']['input'];
}>;
...
export type CreateIdentityMutation = { __typename?: 'mutation_root', insert_user_identities_one: { __typename?: 'user_identities', id: string, user_id: string, provider: string } | null };
...
export type FindIdentityQuery = { __typename?: 'query_root', user_identities: Array<{ __typename?: 'user_identities', id: string, user_id: string, provider: string, provider_user_id: string, provider_email: string | null, is_primary: boolean, verified_at: string | null }> };

export type FindIdentityByEmailQueryVariables = Exact<{
  provider: Scalars['String']['input'];
  email: Scalars['String']['input'];
}>;


export type FindIdentityByEmailQuery = { __typename?: 'query_root', user_identities: Array<{ __typename?: 'user_identities', id: string, user_id: string, provider: string, provider_user_id: string, provider_email: string | null, is_primary: boolean }> };
...
export const CreateTestFlowDocument = `
  ...
  insert_flows_one(
    object: {form_id: $form_id, organization_id: $organization_id, name: $name, flow_type: $flow_type, is_primary: $is_primary, display_order: $display_order}
  ) {
    id
  }
}
    `;
export const CleanupOldTestFormsDocument = `
    mutation CleanupOldTestForms($organization_id: String!, $cutoff_time: timestamptz!) {
  update_forms(
    where: {organization_id: {_eq: $organization_id}, name: {_like: "E2E Test Form%"}, created_at: {_lt: $cutoff_time}, is_active: {_eq: true}}
    ...
    `;
export const CreateTestFormDocument = `
    mutation CreateTestForm($organization_id: String!, $name: String!, $status: String!, $created_by: String!, $product_name: String!, $product_description: String!) {
  insert_forms_one(
    object: {organization_id: $organization_id, name: $name, status: $status, created_by: $created_by, product_name: $product_name, product_description: $product_description, is_active: true}
  ) {
    id
    name
  }
    ...
    `;
export const SoftDeleteTestFormDocument = `
    mutation SoftDeleteTestForm($id: String!) {
...
export const UpdateFormBranchingConfigDocument = `
  ...
  update_forms_by_pk(
    ...
    `;
export const InsertFormAnalyticsEventDocument = `
    mutation InsertFormAnalyticsEvent($organization_id: String!, $form_id: String!, $session_id: String!, $event_type: String!, $step_index: Int, $step_id: String, $step_type: String, $event_data: jsonb!, $user_agent: String) {
  insert_form_analytics_events_one(
    object: {organization_id: $organization_id, form_id: $form_id, session_id: $session_id, event_type: $event_type, step_index: $step_index, step_id: $step_id, step_type: $step_type, event_data: $event_data, user_agent: $user_agent}
  ) {
    id
  }
}
...
export const CreateTestFormQuestionDocument = `
  ...
  insert_form_questions_one(
    object: {step_id: $step_id, organization_id: $organization_id, question_type_id: $question_type_id, question_text: $question_text, question_key: $question_key, display_order: $display_order, is_required: $is_required, is_active: $is_active}
  ) {
    id
  }
}
...
export const CreateOrganizationDocument = `
  ...
  insert_organizations_one(
    ...
    `;
export const FindOrganizationByIdDocument = `
  ...
  organizations_by_pk(id: $id) {
    ...
    `;
export const FindOrganizationBySlugDocument = `
    query FindOrganizationBySlug($slug: String!) {
  organizations(where: {slug: {_eq: $slug}, is_active: {_eq: true}}, limit: 1) {
    id
    name
    slug
    is_active
...
export const AssignRoleDocument = `
    mutation AssignRole($organization_id: String!, $user_id: String!, $role_id: String!, $is_default_org: Boolean!) {
  insert_organization_roles_one(
    object: {organization_id: $organization_id, user_id: $user_id, role_id: $role_id, is_default_org: $is_default_org, joined_at: "now()"}
  ) {
    id
    organization_id
    user_id
    ...
    `;
export const FetchUserRoleInOrgDocument = `
    query FetchUserRoleInOrg($userId: String!, $organizationId: String!) {
  organization_roles(
    where: {user_id: {_eq: $userId}, organization_id: {_eq: $organizationId}, is_active: {_eq: true}}
    limit: 1
  ) {
    id
    organization_id
    ...
    `;
export const FetchUserRolesDocument = `
    query FetchUserRoles($userId: String!) {
  organization_roles(where: {user_id: {_eq: $userId}, is_active: {_eq: true}}) {
    id
    organization_id
    role_id
    is_default_org
    ...
    `;
export const UpdateDefaultOrgDocument = `
    mutation UpdateDefaultOrg($id: String!, $is_default_org: Boolean!) {
  update_organization_roles_by_pk(
    pk_columns: {id: $id}
    _set: {is_default_org: $is_default_org}
  ) {
    id
    is_default_org
  }
    ...
    `;
export const CreateOrganizationPlanDocument = `
    mutation CreateOrganizationPlan($organization_id: String!, $plan_id: String!, $max_forms: Int!, $max_members: Int!, $max_testimonials: Int!, $max_widgets: Int!, $show_branding: Boolean!) {
  insert_organization_plans_one(
    object: {organization_id: $organization_id, plan_id: $plan_id, status: "active", billing_cycle: "lifetime", currency_code: "USD", price_in_base_unit: 0, starts_at: "now()", max_forms: $max_forms, max_members: $max_members, max_testimonials: $max_testimonials, max_widgets: $max_widgets, show_branding: $show_branding}
  ) {
    id
    organization_id
    plan_id
    ...
    `;
export const FindFreePlanDocument = `
    query FindFreePlan {
  plans(where: {unique_name: {_eq: "free"}}, limit: 1) {
    id
    name
    unique_name
    max_forms
...
export const CreateUserDocument = `
    mutation CreateUser($email: String!, $email_verified: Boolean!, $display_name: String, $avatar_url: String, $locale: String!) {
  insert_users_one(
    object: {email: $email, email_verified: $email_verified, display_name: $display_name, avatar_url: $avatar_url, locale: $locale}
  ) {
    id
    email
    email_verified
...
export const FindUserByEmailDocument = `
  ...
  users(where: {email: {_eq: $email}, is_active: {_eq: true}}, limit: 1) {
    id
    email
    email_verified
    display_name
...
export const FindUserByIdDocument = `
  ...
  users_by_pk(id: $id) {
    ...
    `;
export const UpdateUserLoginDocument = `
    mutation UpdateUserLogin($id: String!) {
  update_users_by_pk(pk_columns: {id: $id}, _set: {last_login_at: "now()"}) {
    id
    last_login_at
  }
}
    `;
export const CountUserIdentitiesDocument = `
...
export const CreateIdentityDocument = `
    mutation CreateIdentity($user_id: String!, $provider: String!, $provider_user_id: String!, $provider_email: String, $provider_metadata: jsonb, $is_primary: Boolean!) {
  insert_user_identities_one(
    object: {user_id: $user_id, provider: $provider, provider_user_id: $provider_user_id, provider_email: $provider_email, provider_metadata: $provider_metadata, is_primary: $is_primary, verified_at: "now()"}
  ) {
    id
    user_id
    provider
    ...
    `;
export const FindIdentityDocument = `
    query FindIdentity($provider: String!, $providerUserId: String!) {
  user_identities(
    where: {provider: {_eq: $provider}, provider_user_id: {_eq: $providerUserId}}
    limit: 1
  ) {
    id
    user_id
    ...
    `;
export const FindIdentityByEmailDocument = `
    query FindIdentityByEmail($provider: String!, $email: String!) {
  user_identities(
    where: {provider: {_eq: $provider}, provider_email: {_eq: $email}}
    limit: 1
  ) {
    id
    user_id
...
export const UpdateIdentityDocument = `
  ...
  update_user_identities_by_pk(
    pk_columns: {id: $id}
    _set: {provider_user_id: $provider_user_id, provider_metadata: $provider_metadata}
  ) {
    id
    user_id
    provider
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    CleanupOldTestForms(variables: CleanupOldTestFormsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CleanupOldTestFormsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CleanupOldTestFormsMutation>({ document: CleanupOldTestFormsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CleanupOldTestForms', 'mutation', variables);
    },
    CreateTestForm(variables: CreateTestFormMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateTestFormMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateTestFormMutation>({ document: CreateTestFormDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateTestForm', 'mutation', variables);
    },
    ...
    InsertFormAnalyticsEvent(variables: InsertFormAnalyticsEventMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<InsertFormAnalyticsEventMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertFormAnalyticsEventMutation>({ document: InsertFormAnalyticsEventDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'InsertFormAnalyticsEvent', 'mutation', variables);
    },
    ...
    FindOrganizationById(variables: FindOrganizationByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FindOrganizationByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FindOrganizationByIdQuery>({ document: FindOrganizationByIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FindOrganizationById', 'query', variables);
    },
    ...
    FetchUserRoleInOrg(variables: FetchUserRoleInOrgQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchUserRoleInOrgQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchUserRoleInOrgQuery>({ document: FetchUserRoleInOrgDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FetchUserRoleInOrg', 'query', variables);
    },
    FetchUserRoles(variables: FetchUserRolesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchUserRolesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchUserRolesQuery>({ document: FetchUserRolesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FetchUserRoles', 'query', variables);
    },
    UpdateDefaultOrg(variables: UpdateDefaultOrgMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateDefaultOrgMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateDefaultOrgMutation>({ document: UpdateDefaultOrgDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateDefaultOrg', 'mutation', variables);
    },
    CreateOrganizationPlan(variables: CreateOrganizationPlanMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateOrganizationPlanMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateOrganizationPlanMutation>({ document: CreateOrganizationPlanDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateOrganizationPlan', 'mutation', variables);
    },
    ...
    FindUserByEmail(variables: FindUserByEmailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FindUserByEmailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FindUserByEmailQuery>({ document: FindUserByEmailDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FindUserByEmail', 'query', variables);
    },
    FindUserById(variables: FindUserByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FindUserByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FindUserByIdQuery>({ document: FindUserByIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FindUserById', 'query', variables);
    },
    UpdateUserLogin(variables: UpdateUserLoginMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateUserLoginMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateUserLoginMutation>({ document: UpdateUserLoginDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateUserLogin', 'mutation', variables);
    },
    CountUserIdentities(variables: CountUserIdentitiesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CountUserIdentitiesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CountUserIdentitiesQuery>({ document: CountUserIdentitiesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CountUserIdentities', 'query', variables);
    },
    CreateIdentity(variables: CreateIdentityMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateIdentityMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateIdentityMutation>({ document: CreateIdentityDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateIdentity', 'mutation', variables);
    },
    FindIdentity(variables: FindIdentityQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FindIdentityQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FindIdentityQuery>({ document: FindIdentityDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FindIdentity', 'query', variables);
    },
    FindIdentityByEmail(variables: FindIdentityByEmailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FindIdentityByEmailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FindIdentityByEmailQuery>({ document: FindIdentityByEmailDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FindIdentityByEmail', 'query', variables);
    },
    UpdateIdentity(variables: UpdateIdentityMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateIdentityMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateIdentityMutation>({ document: UpdateIdentityDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateIdentity', 'mutation', variables);
    }
  };
}
