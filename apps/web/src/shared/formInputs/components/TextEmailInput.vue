...
/**
 * TextEmailInput - Modern styled email input
 *
 * Features a clean design with subtle shadows and smooth transitions.
 */
import { Input } from '@testimonials/ui';
