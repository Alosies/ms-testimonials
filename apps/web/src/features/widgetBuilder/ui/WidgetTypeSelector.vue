...
<template>
  <div>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-3" :data-testid="widgetsTestIds.typeSelector">
      ...
      >
        <div class="flex h-10 w-10 items-center justify-center rounded-lg" :class="t.colorClass">
          <Icon :icon="t.icon" class="h-5 w-5" />
        </div>
        <div>
